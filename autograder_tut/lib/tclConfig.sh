...
# installed.
TCL_PREFIX='/mnt/c/users/vic/codes/tutorial/autograder_tut'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/mnt/c/users/vic/codes/tutorial/autograder_tut'
...
TCL_EXTRA_CFLAGS='-march=nocona -mtune=haswell -ftree-vectorize -fPIC -fstack-protector-strong -fno-plt -O2 -ffunction-sections -pipe -isystem /mnt/c/users/vic/codes/tutorial/autograder_tut/include -fdebug-prefix-map=/tmp/build/80754af9/tk_1632504419923/work=/usr/local/src/conda/tk-8.6.11 -fdebug-prefix-map=/mnt/c/users/vic/codes/tutorial/autograder_tut=/usr/local/src/conda-prefix -pipe -m64 -DNDEBUG -D_FORTIFY_SOURCE=2 -O2 -isystem /mnt/c/users/vic/codes/tutorial/autograder_tut/include'
...
TCL_LD_FLAGS='-Wl,-O2 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,--disable-new-dtags -Wl,--gc-sections -Wl,-rpath,/mnt/c/users/vic/codes/tutorial/autograder_tut/lib -Wl,-rpath-link,/mnt/c/users/vic/codes/tutorial/autograder_tut/lib -L/mnt/c/users/vic/codes/tutorial/autograder_tut/lib -Wl,--export-dynamic '
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/mnt/c/users/vic/codes/tutorial/autograder_tut/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/mnt/c/users/vic/codes/tutorial/autograder_tut/include'
...
TCL_PACKAGE_PATH='{/mnt/c/users/vic/codes/tutorial/autograder_tut/lib} '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/mnt/c/users/vic/codes/tutorial/autograder_tut/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/tmp/build/80754af9/tk_1632504419923/work/tcl8.6.11/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/mnt/c/users/vic/codes/tutorial/autograder_tut/lib/libtclstub8.6.a'
